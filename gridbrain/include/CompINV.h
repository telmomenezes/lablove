...
#ifndef _INCLUDE_GRIDBRAIN_COMPONENT_INV_H
#define _INCLUDE_GRIDBRAIN_COMPONENT_INV_H

#include "GridbrainComponent.h"

class CompINV : public GridbrainComponent
{
public:
    CompINV();
    virtual ~CompINV();
    ...
    virtual string getName(){return "INV";}
