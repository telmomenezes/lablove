...
#ifndef _INCLUDE_GRIDBRAIN_COMPONENT_TMEM_H
#define _INCLUDE_GRIDBRAIN_COMPONENT_TMEM_H
...
class CompTMEM : public Component
{
public:
    CompTMEM();
    virtual ~CompTMEM();
    ...
    virtual string getName(){return "TMEM";}
