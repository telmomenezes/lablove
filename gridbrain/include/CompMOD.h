...
#ifndef _INCLUDE_GRIDBRAIN_COMPONENT_MOD_H
#define _INCLUDE_GRIDBRAIN_COMPONENT_MOD_H

#include "GridbrainComponent.h"

class CompMOD : public GridbrainComponent
{
public:
    CompMOD();
    virtual ~CompMOD();
    ...
    virtual string getName(){return "MOD";}
