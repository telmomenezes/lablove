...
agentSpecies:addGoal(SimObj2D.FITNESS_LASER_HIT_SCORE, bufferSize / 3)
agentSpecies:addGoal(SimObj2D.FITNESS_LASER_EFF_SCORE, bufferSize / 3)
agentSpecies:addGoal(SimObj2D.FITNESS_SYNCH_SCORE, bufferSize / 3)
