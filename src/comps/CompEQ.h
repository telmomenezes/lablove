...
#ifndef _INCLUDE_GRIDBRAIN_COMPONENT_EQ_H
#define _INCLUDE_GRIDBRAIN_COMPONENT_EQ_H

#include "GridbrainComponent.h"

class CompEQ : public GridbrainComponent
{
public:
    CompEQ();
    virtual ~CompEQ();
    ...
    virtual string getName(){return "EQ";}
