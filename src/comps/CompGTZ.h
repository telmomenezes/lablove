...
#ifndef _INCLUDE_GRIDBRAIN_COMPONENT_GTZ_H
#define _INCLUDE_GRIDBRAIN_COMPONENT_GTZ_H

#include "GridbrainComponent.h"

class CompGTZ : public GridbrainComponent
{
public:
    CompGTZ();
    virtual ~CompGTZ();
    ...
    virtual string getName(){return "GTZ";}
