...
#ifndef _INCLUDE_GRIDBRAIN_COMPONENT_NEG_H
#define _INCLUDE_GRIDBRAIN_COMPONENT_NEG_H

#include "GridbrainComponent.h"

class CompNEG : public GridbrainComponent
{
public:
    CompNEG();
    virtual ~CompNEG();
    ...
    virtual string getName(){return "NEG";}
