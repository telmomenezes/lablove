...
#ifndef _INCLUDE_GRIDBRAIN_COMPONENT_OUT_H
#define _INCLUDE_GRIDBRAIN_COMPONENT_OUT_H

#include "GridbrainComponent.h"

class CompOUT : public GridbrainComponent
{
public:
    CompOUT();
    virtual ~CompOUT();
